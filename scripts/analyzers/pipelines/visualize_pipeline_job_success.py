...
def main():
    ...
    output_dir = base_dir / 'visualizations' / project_type / 'pipeline_job_success'
    ...
    for project_id, project_name in projects:
        ...
        if job_stats:
            ...
            output_file = output_dir / f'{project_label.lower()}_job_success.png'
    ...
    stats_file = summary_dir / 'pipeline_job_success_statistics.csv'
